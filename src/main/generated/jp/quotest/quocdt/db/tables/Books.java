...
import jp.quotest.quocdt.db.tables.BookAuthors.BookAuthorsPath;
...
public class Books extends TableImpl<BooksRecord> {
     ...
     */
    public final TableField<BooksRecord, Long> PRICE = createField(DSL.name("price"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.books.publication_status</code>.
     */
    public final TableField<BooksRecord, Boolean> PUBLICATION_STATUS = createField(DSL.name("publication_status"), SQLDataType.BOOLEAN.nullable(false), this, "");
