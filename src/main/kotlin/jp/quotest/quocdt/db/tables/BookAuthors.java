 ...
 */
package jp.quotest.quocdt.db.tables;
...
import jp.quotest.quocdt.db.Keys;
import jp.quotest.quocdt.db.Public;
import jp.quotest.quocdt.db.tables.Authors.AuthorsPath;
import jp.quotest.quocdt.db.tables.Books.BooksPath;
...
public class BookAuthors extends TableImpl<BookAuthorsRecord> {
    ...
    /**
     * The column <code>public.book_authors.id</code>.
     */
    public final TableField<BookAuthorsRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    ...
    @Override
    public Identity<BookAuthorsRecord, Integer> getIdentity() {
        return (Identity<BookAuthorsRecord, Integer>) super.getIdentity();
    }
    ...
    @Override
    public List<UniqueKey<BookAuthorsRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.BOOK_AUTHORS_BOOK_ID_AUTHOR_ID_KEY);
    }
